...
import UsrFormDialog from './UsrFormDialog.vue';
      ...
      onMore(index, row) {
        ...
        axios({
          ...
          data: JSON.stringify(requestData)
            ...
            this.details.acceptTaskNum = response.data['acceptTaskNum'];
            this.details.finishTaskNum = response.data['finishTaskNum'];
            this.details.userCoin = response.data['userCoin'];
            this.details.userScore = response.data['userScore'];
